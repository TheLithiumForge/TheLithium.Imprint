...
- A structural question has one implementation. Two correct answers to the same question, such as how a section is located, how a status is named, or how a path is normalized, are a defect even while they agree, because nothing keeps them agreeing. Find the existing owner before writing the second answer.
