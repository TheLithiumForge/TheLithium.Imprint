...
public interface ISnapshotComparer
{
    ...
    /// <param name="options">The effective equality rules for this capture.</param>
    /// <returns>A match or a difference to include in the aggregate assertion report.</returns>
    SnapshotComparisonResult Compare(string expected, string received, SnapshotFormat format, SnapshotComparison options);
}
